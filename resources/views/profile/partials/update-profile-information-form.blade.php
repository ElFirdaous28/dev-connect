        ...
        <div class="flex gap-2 justify-evenly">
            <div class="w-3/5 space-y-5">
                ...
                <div>
                    ...
                    <x-text-input id="headline" name="headline" type="text" class="mt-1 block w-full" :value="old('headline', $user->headline)" autofocus autocomplete="headline" />
                ...
                <div>
                    ...
                    <x-text-input id="github_link" name="github_link" type="text" class="mt-1 block w-full" :value="old('github_link', $user->github_link)" autofocus autocomplete="github_link" />
                    <x-input-error class="mt-2" :messages="$errors->get('github_link')" />
                </div>

                <div>
                    <x-input-label for="gitlab_link" :value="__('GitLab Link')" />
